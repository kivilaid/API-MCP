...
import { APIPromise } from 'sss/core/api-promise';

import util from 'node:util';
import SSs from 'sss';
import { APIUserAbortError } from 'sss';
...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    const forceAPIResponseForClient = async (client: SSs) => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['SSS_BASE_URL'] = undefined;
    });
