...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['SSS_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['SSS_LOG'] or 'warn' if it isn't set.
   */
...
export class SSs {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? SSs.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('SSS_LOG'), "process.env['SSS_LOG']", this) ??
      defaultLogLevel;
  ...
  static SSsError = Errors.SSsError;
