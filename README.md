# SSs TypeScript API Library

[![NPM version](https://img.shields.io/npm/v/sss.svg)](https://npmjs.org/package/sss) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/sss)
...
```sh
npm install git+ssh://git@github.com:kivilaid/remote-mcp-server-authless.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npm install sss`
...
1. Via the `SSS_LOG` environment variable
...
We are keen for your feedback; please open an [issue](https://www.github.com/kivilaid/remote-mcp-server-authless/issues) with questions, bugs, or suggestions.
