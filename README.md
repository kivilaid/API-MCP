...
```sh
npm install git+ssh://git@github.com:kivilaid/API-MCP.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/kivilaid/API-MCP/issues) with questions, bugs, or suggestions.
